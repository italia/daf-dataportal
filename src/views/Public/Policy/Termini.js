        ...
        <div className="container p-5 mt-2">
          <div className="row mt-4">
            <div className="paragrafo col-12 mx-0">
              <h1 className="ml-0" id='ter-1'>1. Termini</h1>
            </div>
            <div className="paragrafo col-7 mx-0">
              ...
              <h1 className="ml-0" id='ter-1.2'>1.2 Termini</h1>
            </div>
            <div className="col-md-3 mx-auto p-0">
              ...
              <div className="nav">
                <ul>
                  <li><button className="btn btn-link text-primary" onClick={this.handleScroll.bind(this, 'ter-1')}>1. Termini </button></li>
                  <li><button className="btn btn-link text-primary" onClick={this.handleScroll.bind(this, 'ter-1.2')}>1.2 Termini </button></li>
                  <li><button className="btn btn-link text-primary" onClick={this.handleScroll.bind(this, 'ter-2')}>2. Termini </button></li>
                </ul>
            ...
            <div className="paragrafo col-7 mx-0">
              ...
              <h1 className="ml-0" id='ter-2'>2. Termini</h1>
            </div>
            <div className="paragrafo col-7 mx-0">
