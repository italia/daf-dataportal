                        ...
                        <div className="col-2 my-2">
                            {
                                ...
                                <span className="pointer" title='Il dataset è privato'><i className="fas fa-lock fa-pull-right text-icon pointer" style={{fontSize: '16px'}}/></span>
                            }
                            {
                                openData &&
                                ...
                                <span className="pointer" title='Il dataset è pubblico'><i className="fas fa-globe fa-pull-right text-icon pointer" style={{fontSize: '16px'}}/></span>
                            }
                        </div>
                    </div>
